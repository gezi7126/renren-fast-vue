    ...
    ></add-or-update>
      ...
      <el-popover placement="right-end" v-model="popCatelogSelectVisible">
        <category-cascader :catelogPath.sync="catelogPath"
         @listenChildNodesPath="getCheckedNodesPathFormChild">
        </category-cascader>
...
export default {
  ...
  methods: {
    ...
    //获取品牌id关联的所有品牌分类关系表中的相关信息
    getCateRelation() {
      this.$http({
        url: this.$http.adornUrl("/product/categorybrandrelation/product/list"),
        method: "get",
        params: this.$http.adornParams({
