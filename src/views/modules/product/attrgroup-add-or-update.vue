  ...
  <el-dialog
    ...
    <el-form-item label="所属分类id" prop="catelogId">
      ...
      <!-- <el-cascader filterable placeholder="试试搜索：手机" v-model="catelogPath" :options="categorys"  :props="props"></el-cascader> -->
        <!-- :catelogPath="catelogPath"自定义绑定的属性，可以给子组件传值,[2,5,225] -->
       <category-cascader
         ref="categoryCascaderPath"
        :catelogPath.sync="catelogPath" @listenChildNodesPath="getCheckedNodesPathFormChild"></category-cascader>
    ...
    methods: {
          ...
          if (this.dataForm.attrGroupId) {
            this.$http({
              ...
              if (data && data.code === 0) {
                ...
                this.dataForm.catelogId=this.catelogPath[this.catelogPath.length-1];
      ...
      dataFormSubmit () {
        this.$refs['dataForm'].validate((valid) => {
          let path=this.catelogPath[this.catelogPath.length-1];
          alert(path);
          if (valid) {
            this.$http({
      ...
      getCheckedNodesPathFormChild(value) {
        console.log("paths.....",value);
        alert("vvvvv..........."+value);
        this.catelogPath=value;
