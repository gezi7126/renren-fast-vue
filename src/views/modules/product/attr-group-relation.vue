        ...
        <el-col :span="24">
          ...
          >
            ...
            <el-table-column fixed="right" header-align="center" align="center" label="操作">
              <template slot-scope="scope">
                <el-button type="text" size="small" @click="relationRemove(scope.row.attrId)">解除关联</el-button>
              </template>
            </el-table-column>
          </el-table>
        </el-col>
  ...
  methods: {
    ...
    submitAddRealtion() {
      ...
      if (this.innerdataListSelections.length > 0) {
        ...
        this.$http({
          url: this.$http.adornUrl("/product/attrgroup/attr/relation/save"),
          method: "post",
          data: this.$http.adornData(postData, false)
        }).then(({ data }) => {
          if (data.code == 0) {
