  ...
  >
    <el-form :model="dataForm" :rules="dataRule" ref="dataForm" label-width="120px">
      ...
      <el-form-item label="所属分类" prop="catelogId">
        <category-cascader :catelogPath.sync="catelogPath" @listenChildNodesPath="getCheckedNodesPathFormChild"></category-cascader>
      </el-form-item>
        ...
        if (this.dataForm.attrId) {
          this.$http({
            ...
            if (data && data.code === 0) {
              ...
              if(this.type==1){
                this.$nextTick(() => {
                   this.getCheckedNodesPathFormChild(data.attr.catelogPath);
